...
class EventProvider extends ChangeNotifier {
  ...
  Future<void> loadEvents({
    ...
    bool usePublicEndpoint = false, // New parameter for public events
  }) async {
    // For public events, token is not required
  ...
  Future<void> loadEvent(String eventId) async {
    ...
    try {
      ...
      // Provjeri da li je response validan
      if (response.isEmpty) {
  ...
  Future<bool> updateEvent(String eventId, Map<String, dynamic> eventData) async {
    ...
    try {
      ...
      // Reload current event and events list
      await Future.wait([
        loadEvent(eventId),
