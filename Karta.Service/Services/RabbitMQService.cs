...
namespace Karta.Service.Services
{
    ...
    public class NullRabbitMQService : IRabbitMQService
    {
        ...
        {
            // Do nothing when RabbitMQ is disabled
        }
        ...
        {
            return false; // Always return false when RabbitMQ is disabled
        }
    }
    ...
    public class RabbitMQService : IRabbitMQService, IDisposable
    {
            ...
            ILogger<RabbitMQService> logger)
        {
            ...
            catch (Exception ex)
            {
                ...
                // Ne baci exception, samo loguj grešku
            }
        }
        ...
        public void PublishEmailMessage(EmailMessage message)
        {
            ...
            try
            {
                ...
                properties.Persistent = true; // Sačuvaj poruku na disk
        ...
        public void StartConsuming()
        {
            ...
            consumer.Received += async (model, ea) =>
            {
                try
                {
                    ...
                    if (message != null)
                    {
                        ...
                        // TODO: Implementiraj direktno slanje email-a ovdje ili koristi factory pattern
                        _logger.LogInformation("Email message received from RabbitMQ: {Email} - {Subject}", message.ToEmail, message.Subject);

                        // Potvrdi da je poruka obrađena
                ...
                catch (Exception ex)
                {
                    ...
                    // Odbaci poruku ako ne može biti obrađena
            ...
            _channel!.BasicConsume(
                queue: _queueName,
                autoAck: false, // Ručno potvrđujemo poruke
                consumer: consumer
            );
