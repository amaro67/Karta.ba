...
{
    /// <summary>
    /// Kontroler za upravljanje rolama
    /// </summary>
    [ApiController]
    ...
    public class RoleController : ControllerBase
    {
        ...
        /// </summary>
        /// <param name="name">Naziv role</param>
        /// <returns>Rolu</returns>
        [HttpGet("name/{name}")]
        [SwaggerOperation(
        ...
        /// Briše rolu
        /// </summary>
        /// <param name="id">ID role za brisanje</param>
        ...
        /// <returns>Rezultat dodavanja</returns>
        [HttpPost("users")]
        [Authorize(Roles = "Admin")]
        [SwaggerOperation(
        ...
        /// <returns>Rezultat uklanjanja</returns>
        [HttpDelete("users")]
        [Authorize(Roles = "Admin")]
        [SwaggerOperation(
