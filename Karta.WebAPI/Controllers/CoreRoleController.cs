...
{
    /// <summary>
    /// Kontroler za upravljanje 4 ključne role: User, Organizer, Scanner, Admin
    /// </summary>
    [ApiController]
    ...
    public class CoreRoleController : ControllerBase
    {
        ...
        /// <summary>
        /// Vraća sve 4 ključne role sa njihovim dozvolama
        /// </summary>
        [HttpGet("roles")]
        [AllowAnonymous]
        ...
        public async Task<IActionResult> AssignRole([FromBody] AssignRoleRequest request)
        {
            ...
            // Provjeri da li je rola jedna od 4 ključne
        ...
        /// <summary>
        /// Vraća sve korisnike sa njihovim rolama
        /// </summary>
        [HttpGet("users")]
        [RequirePermission("ManageUsers")]
