...
{
    /// <summary>
    /// Kontroler za autentifikaciju i autorizaciju korisnika
    /// </summary>
    [ApiController]
    ...
    public class AuthController : ControllerBase
    {
        ...
        /// <returns>JWT tokeni i informacije o korisniku</returns>
        /// <response code="200">Uspješna prijava</response>
        /// <response code="400">Neispravni podaci za prijavu</response>
        [HttpPost("login")]
        [SwaggerOperation(
        ...
        /// </summary>
        /// <returns>Poruka o uspješnoj odjavi</returns>
        /// <response code="200">Uspješna odjava</response>
        ...
        /// <summary>
        /// Obnavljanje JWT tokena
        /// </summary>
        /// <param name="request">Access token i refresh token</param>
        /// <returns>Novi JWT tokeni</returns>
        /// <response code="200">Tokeni su uspješno obnovljeni</response>
        /// <response code="400">Neispravni tokeni</response>
        ...
        public async Task<IActionResult> ResendConfirmation([FromBody] ResendConfirmationRequest request)
        {
            ...
            // Privremeno onemogućeno email slanje za testiranje
            // await _emailService.SendEmailConfirmationAsync(user.Email!, confirmationLink!);
        ...
        /// </summary>
        /// <returns>Informacije o korisniku iz tokena</returns>
        /// <response code="200">Token je valjan</response>
        /// <response code="401">Neautorizovani pristup</response>
        ...
        /// Test email slanja
        /// </summary>
        /// <param name="email">Email adresa za test</param>
        /// <returns>Poruka o uspješnom slanju</returns>
        [HttpPost("test-email")]
        [AllowAnonymous]
        [SwaggerOperation(
        ...
        /// <summary>
        /// Briše sve korisnike osim određenog korisnika
        /// </summary>
        ...
        public async Task<IActionResult> BulkDeleteUsers([FromBody] BulkDeleteUsersRequest request)
        {
            ...
            // Provjeri da li korisnik koji se zadržava postoji
            ...
            // Dohvati sve korisnike osim onog koji se zadržava
            ...
            if (errors.Any())
            {
                return Ok(response); // Vraćamo 200 jer su neki korisnici uspješno obrisani
            }
